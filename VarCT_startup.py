...
parser.add_argument("-n", "--num_ivs", help="Simulate how many trajectories", default="50", type=int)
parser.add_argument("-t", "--timehorizon", help="Simulate which time horizon", default="15", type=int)
